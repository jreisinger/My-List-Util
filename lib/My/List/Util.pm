...
Returns the sum of the numbers passed to it, skipping arguments that are not
numbers.
...
Returns the list elements in random positions. Based on fisher_yates_shuffle
from perlfaq4.
...
sub shuffle {
    my @deck = @_;
    return unless @deck;    # return empty list or undef
...
Jozef Reisinger, C<< <jreisinger at ist.ac.at> >>
...
Copyright 2014 Jozef Reisinger.
